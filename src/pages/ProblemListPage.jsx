...
const ProblemListPage = () => {
  ...
  const handleNext = () => {
    if ((pageNumber + 1) * pageSize < totalCount) setPageNumber(pageNumber + 1);
  };

  return (
    <div style={{ textAlign: "center", padding: "40px" }}>
      <LogoHeader />
      <h1 style={{ fontSize: "36px", marginBottom: "40px" }}>📚 전체 문제 리스트</h1>
      ...
      <div style={{ marginTop: "30px" }}>
        ...
        <span style={{ fontSize: "16px", fontWeight: "bold" }}>페이지 {pageNumber}</span>
        <button
          onClick={handleNext}
          ...
          style={{
            ...
            borderRadius: "4px",
            border: "1px solid #ccc",
            cursor: (pageNumber + 1) * pageSize >= totalCount ? "not-allowed" : "pointer",
            backgroundColor: "#fff"
          }}
        >
          다음 ▶
